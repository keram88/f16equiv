...
rustc $EXTRA_RUSTC --crate-name half $HALF_PATH/src/lib.rs --crate-type lib -g -C metadata=d8c98ac24eff6c31 --out-dir ./target/debug/deps/ --emit=dep-info,link
cp ./target/debug/deps/half.bc files/
...
rustc $EXTRA_RUSTC --crate-name $CRATE src/main.rs -g -C metadata=fdf0e253751e7ecc --out-dir $OUTPUT_DIR --extern half=./target/debug/deps/libhalf-d8c98ac24eff6c31.rlib
